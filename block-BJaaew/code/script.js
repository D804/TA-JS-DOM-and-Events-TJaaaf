...
function createUI(){
    let createHTML = allPeople.map((person)=>{
...
let lanister= document.querySelector(".Lanister");
...
let drogo= document.querySelector(".Drogo");
snow.addEventListener("click",()=>{
    allPeople.filter((todo)=>todo.name);
    createUI();
});
ul.innerHTML = createHTML.join("");
